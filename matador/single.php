                    ...
                    <div id="main" class="<?php echo esc_attr(ts_main_div_class());?> clearfix">
                        <div class="entry single-entry clearfix">
                            ...
                            if($ts_show_featured_media == 'yes') :
                                $featured_media_vars = array('media_width'=>$crop_width,'media_height'=>$crop_height,'allow_audio'=>1,'allow_self_hosted_video'=>1, 'is_single'=>1, 'show_caption'=>1);
                                        ...
                                        <div class="ts-about-author-wrap ts-post-section-inner">
                                            <div class="ts-about-author">
                                                <div class="author-id">
                                                    ...
                                                    <h6 class="smaller"><?php echo __('Posted by', 'ThemeStockyard'); ?></h6>
