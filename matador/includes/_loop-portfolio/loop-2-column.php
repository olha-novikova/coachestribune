...
?>
                <div class="portfolio-entries-wrap not-masonry-entries-wrap <?php echo esc_attr($edge_class);?>">
                    ...
                    <div class="portfolio-loop-2-column hfeed portfolio-entries entries loop <?php echo esc_attr($entries_class);?> clearfix">
                        <?php
                        if($ts_query->have_posts()) : 
                            $i = 1;
                            while($ts_query->have_posts()) : $ts_query->the_post();
                        ?>                        
                        <div id="post-<?php echo esc_attr($ts_query->post->ID);?>" class="hentry entry ts-boxed-one-half <?php echo esc_attr(ts_get_the_category('portfolio-category', 'filter-slugs', ' '));?>">
                            <div class="post-content">
                                ...
                                <div class="title-info">                               
                                    ...
                                    <div class="title-info-inner">
                                        <h3 class="title text-center entry-title"><?php the_title();?></h3>
