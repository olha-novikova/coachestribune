                    ...
                    <<?php echo tag_escape($container_el);?> class="<?php echo esc_attr($container_class);?>" data-slide-width="<?php echo absint($img_width);?>" data-desired-slide-width="<?php echo absint($img_width);?>">
                        ...
                        if($ts_query->have_posts()) : 
                            while($ts_query->have_posts()) :
                                ...
                                if($fullwidth) :
                                    $img_height = 500;
                                    $style = ($media->format == 'standard') ? 'background:url('.$media->photo.');height:'.$img_height.'px' : '';
                                endif;
                        ?>                        
                        <<?php echo tag_escape($item_el);?> class="<?php echo esc_attr($item_class);?> ts-slider-item" data-width="<?php echo absint($img_width);?>" data-height="<?php echo absint($img_height);?>" style="<?php echo esc_attr($style);?>">
                            <?php
