...
?>
                <div class="loop-wrap loop-2-column-wrap <?php echo esc_attr(ts_loop_wrap_class($atts));?>">
                    <div class="hfeed entries blog-entries loop loop-2-column <?php echo esc_attr($entries_class);?> clearfix">
                        <?php
                        $exc_lnth = ts_option_vs_default('excerpt_length_2col_medium', 160);
                        ...
                        $mw = 510;
                        $mh = ts_loop_media_height('2column', $atts, $mw);
                        ...
                        <div id="post-<?php echo esc_attr($ts_query->post->ID);?>" class="hentry entry span6">
