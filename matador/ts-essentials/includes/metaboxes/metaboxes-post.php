...
{	    
    ...
    $meta_boxes[] = array(
        ...
        'pages'      => ts_metaboxes_post_types('post'),
        'context'    => 'normal',
        'priority'   => 'high',
        'show_names' => true,
        'fields'     => array(
            ...
            array(
                'name'    => __('Alternate Title', 'ThemeStockyard'),
                'id'      => $prefix . 'alt_title',
                'type'    => 'text',
                'std'     => '',
                "desc"     => __('This title will appear within results, but not on the single post page.', 'ThemeStockyard')
            ),
            ...
            */
            ...
            array(
                'name'    => __('Image 11' , 'ThemeStockyard'),
                'desc'    => __('Upload an image or enter an URL.' , 'ThemeStockyard'),
                'id'      => $prefix . 'image_11',
                'type'    => 'file',
                'save_id' => true,
            ...
            array(
                'name'    => __('Image 12' , 'ThemeStockyard'),
                'desc'    => __('Upload an image or enter an URL.' , 'ThemeStockyard'),
                'id'      => $prefix . 'image_12',
                'type'    => 'file',
                'save_id' => true,
            ...
            array(
                'name' => __('"Link" Settings', 'ThemeStockyard'),
                'desc' => __('This section is only useful when the "post format" is set to "Link". They are only useful within the "loop" - not on single post pages.', 'ThemeStockyard'),
                'type' => 'title',
                'id'   => $prefix . 'link_title_menu_setting'
            ),

            array(
                'name' => __('Alternate URL', 'ThemeStockyard'),
                'desc' => '',
                'type' => 'text',
                'id'   => $prefix . 'link'
            ),
            ...
            array(
                'name' => __('Alternate Author', 'ThemeStockyard'),
                'desc' => __('The name entered here will appear if an "Alternate URL" is also present.', 'ThemeStockyard'),
                'type' => 'text',
                'id'   => $prefix . 'link_author'
            ),
            /*
            array(
                'name' => __('Replace post permalink with URL within loop?', 'ThemeStockyard'),
                'id'      => $prefix . 'link_redirect',
                'type'    => 'select',
                'options' => array(
                    array('name' => __('Use default', 'ThemeStockyard'), 'value' => 'default'),
                    array('name' => __('Yes', 'ThemeStockyard'), 'value' => 'yes'),
