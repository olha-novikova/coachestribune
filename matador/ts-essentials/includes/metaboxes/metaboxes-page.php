...
function cmb_page_metaboxes(array $meta_boxes) 
{
    ...
    $ts_cmb_slider_categories 		= array(); 
    $ts_cmb_slider_categories_obj 	= get_categories('taxonomy=slider-category&hide_empty=0');
    if(is_array($ts_cmb_slider_categories_obj) && !isset($ts_cmb_slider_categories_obj['errors'])) {
        foreach ($ts_cmb_slider_categories_obj as $cmb_slider_cat) {
            $ts_cmb_slider_categories[$cmb_slider_cat->term_id] = $cmb_slider_cat->cat_name;
        }
    }        
    ...
    if(defined( 'TS_ESSENTIALS_SLIDER_POSTS_PLUGIN_VERSION' )) {
        $ts_slider_sources[] = array('name' => __('Slider Posts', 'ThemeStockyard'),  'value' => 'slider');
    }
    ...
    $meta_boxes[] = array(
        ...
        'fields'     => array(
            ...
            */
            ...
            array(
                'name'    => __('Slider Category', 'StoryAndCraft'),
                'id'      => $prefix . 'slider_category',
                'desc'    => __('To use &#8220;Slider posts&#8221;, you must first <a href="post-new.php?post_type=slider">create slides</a> and <a href="edit-tags.php?taxonomy=slider-category&post_type=slider">slider categories</a>.', 'StoryAndCraft'),
            ...
            */
            ...
            /*
            array(
                'name'    => __('First page only?', 'ThemeStockyard'),
                'id'      => $prefix . 'slider_first_page',
                'desc'    => __('If set to "Yes", the slider will not appear on paginated pages (page 2, 3, etc...)', 'ThemeStockyard'),
                'type'    => 'select',
                'options' => array(
                    array('name' => __('Yes', 'ThemeStockyard'), 'value' => 'yes'),
                    array('name' => __('No', 'ThemeStockyard'), 'value' => 'no'),
