...
<?php 
    $comment_form = array( 
        'fields' => apply_filters('comment_form_default_fields', array(
            ...
            'logged_in_as' => '',
            'title_reply' => '<span class="smaller uppercase">' . __('Have you done this? What can you add to this tip?', 'ThemeStockyard') . '</span>',
            'title_reply_to' => '<span class="smaller uppercase">' . __('Have you done this? What can you add to this tip?', 'ThemeStockyard') . '</span> <strong>%s</strong>',
