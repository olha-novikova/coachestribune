...
class="<?php echo esc_attr(ts_main_container_wrap_class('page')).' '.esc_attr($main_container_wrap_class);?>">
    ...
    ?>
    <div id="profile-header" class="<?php echo $class; ?>" style="background: <?= $backgroundStyle ?>; background-size: cover;">
        <?php if(is_user_logged_in() && current_user_can( 'edit_user', $curauth->ID )) : ?>
            <form id="jrrny-edit-header-form" action="<?= admin_url().'admin-ajax.php'?>" method="post" enctype="multipart/form-data">
                ...
                <div class="fileUpload btn btn-danger">
                    <span><?php if($class === 'image'){ ?>Change image<?php } else { ?>Add Photo<?php }?></span>
    ...
    <div id="profile-stats-bar">
        <div class="container-custom">
            <div class="row">
                <div id="avatar-wrapper" class="col-sm-3 col-xs-6 ">
                    ...
                    <?php if(is_user_logged_in()) : ?>
                        ...
                        <?php if(current_user_can( 'edit_user', $curauth->ID )) : ?>
                                <a href="" id="jrrny-author-edit-btn" class="btn button" data-toggle="modal" data-target="#jrrny-auhor-edit">edit profile</a>
                        <?php endif; ?>
                        <?php if($current_user->ID != $curauth->ID) : ?>
                            <a href="" id="jrrny-author-follow-btn" class="btn button 
                ...
                <div class="col-lg-2 col-lg-push-5 col-sm-3 col-sm-push-3 col-xs-3 stats jrrnys">
                <b><?php echo sprintf("%02d", getJrrnysCount($curauth->ID)); ?> </b><small>TIPS</small></div>
                <div class="col-lg-2 col-lg-push-5 col-sm-3 col-sm-push-3 col-xs-3 stats upvoted">
                <b><?php echo sprintf("%02d", getUpvotesCount($curauth->ID)); ?></b> <small>LIKED</small></div>
            </div>
        </div>
    </div>
    ...
    <div id="tabs-bar">
        <div id="profile-tabs" class="container-custom">
            <div class="row">
                ...
                <div data-tab="my-jrrnys" class="col-xs-4 text-center profile-tab active"><i class="fa fa-map-marker"></i> <span class="hidden-xs"><?php echo (get_current_user_id() == $curauth->ID) ? "my " : "";?>tips</span></div>
    ...
    <div id="main-container" class="container clearfix">
        <div class="col-sm-12">
            ...
            <div class="tab-page visible" id="tab-my-jrrnys">
                <h2><i class="fa fa-map-marker"></i> Tips</h2>
