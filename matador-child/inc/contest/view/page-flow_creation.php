    ...
    <div class="content-cell <?php echo $page_flow;?>">
        <div class="content-container">
            ...
            <div class="content" id="wizzard">
                    ...
                    <div class="col-md-6">
                        ...
                        if (is_user_logged_in()) {
                            ...
                            <div class="wizzar-contest-user-logged">
                                ...
                                <button id="add-to-contest" class="btn btn-turquoise">ENTER&nbsp;<i class="fa processing-icon hide"></i></button>
                            </div>
                        <?php
                        }
                        else {
                ...
                <div id="step_2" class="row hidden">
                    <div class="col-xs-12 margin-bottom-20">
                        <?php echo apply_filters('the_content', $step_2); ?>
                    </div>
                     <div class="col-md-5 upload-info">
                         <p>Example:</p>
                         <p>Where you went: <i>'Austin, Tx'</i></p>
                         <p>FOR:</p>
                         <p>What did you do: <i>'The Best BBQ'</i></p>
                ...
                <div id="step_3" class="row hidden">
                    <?php include TS_SERVER_PATH . "/inc/frontend/upload/uploader.php"; ?>
                </div>
                <div id="step_4" class="hidden">
                    <?php echo apply_filters('the_content', $step_3); ?>                   
                </div>
                <div id="step_5" class="hidden">
                    <?php echo apply_filters('the_content', $step_4); ?>                   
                </div>
            </div>
        </div>
    </div>
