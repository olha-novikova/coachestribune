              ...
              $msg .= '<div class="modal-body">';
                  ...
                  $msg .= '<div class="contest_sharre_modal_wrapper">';
                    $msg .= '<form id="contestSendEmails_form">';
                        ...
                        $msg .= '<p><button id="contestSendEmails" class="btn btn-turquoise">Send Invite <i class="fa processing-icon hide"></i></button></p>';                        
...
function wizzard_step_2()
{
    ...
    $msg = '<div class="wizzard-step-2">';
        ...
        $msg .= '</div>';
        if($next){
            $msg .= '<p class="text-right"><button data-step="5" class="btn btn-turquoise next-step">Next&nbsp;<i class="fa processing-icon hide"></i></button></p>';
        }
    $msg .= '</div>';
...
{    
    ...
    $sql .= "user_id = '" . $user_id . "' ";
    $sql .= "AND ";
    $sql .= "meta_key = 'contest_end_date' ";
    $sql .= "AND ";
    $sql .= "meta_value >= '" . date('Ymd') . "' ";
    $sql .= "GROUP BY contest_id";
