<div class="upload-widget small-widget">
    ...
    <form id="top_upload" metgod="GET" action="<?php echo home_url();?>/upload">
        ...
        <div class="form-group text-right">
            <button type="submit" id="header_btn" data-form="top_upload" class="btn btn-turquoise <?php echo !is_user_logged_in() ? 'login_modal' : '' ?>">Next&nbsp;<i class="fa processing-icon hide"></i></button>
        </div>
    </form>
</div>