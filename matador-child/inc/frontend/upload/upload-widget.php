<div class="upload-widget">
    <div class="title">
        <i class="flaticon flaticon-checkbox-pen-outline"></i> Create your tip
    </div>
    <div class="text">
        Share with the community your coach experiences<br/> 
        Local or on the other side of the world. Let us hear your tip.
    </div>  
    <form id="top_upload" metgod="GET" action="<?php echo home_url();?>/upload">
        ...
        <div class="form-group text-right">
            <button type="submit" id="header_btn" data-form="top_upload" class="btn btn-turquoise <?php echo !is_user_logged_in() ? 'login_modal' : '' ?>">Next</button>
        </div>
    </form>
</div>