...
<div class="container">
	...
	<form id = "lostpassword_form" method="post" action="" class="wp-user-form" data-redirect="<?php echo site_url().'#login-form' ?>">
	    ...
	    <div class="input-group">
	        <button id="lostpassword_btn" class="btn btn-success" name="user-submit"><?php _e('Reset my password'); ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>
        	When it arrives, click <a id="login-out-lnk" class="top-bar-ma-lnk login_modal">here</a> to log back.
        </p>
      </div>
    </div>
  </div>
