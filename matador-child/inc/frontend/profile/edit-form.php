    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <label for="quota">WHY DO YOU ENJOY COACHES TRIBUNE? (100 Characters)</label>
            ...
            <div class="modal-footer">
                <button id="remove-account" class="pull-left btn btn-danger">Remove account</button>
                <div id="profile-updated" class="hidden">Your profile has been updated!</div>
                <button type="submit" id="jrrny-edit-profile-btn" class="btn btn-primary">UPDATE&nbsp;<i
                        class="fa processing-icon hide"></i></button>
