...
function ts_theme_setup()
{
    ...
    if (function_exists('wp_review_theme_defaults')) {
        $color_options = array(
            'colors' => array(
                'color' => ts_option_vs_default('primary_color', '#e71d36'),
...
function ts_get_top_bar()
{
    ...
    if (in_array($show_top_bar, array('yes', 'social'))) :
        ...
        $html .= "<a href='" . home_url() . "/upload' class=\"top-bar-ma-lnk\"><i class=\"fa fa-plus-circle\"></i> Create Coaching Tip</a>";
...
function newNav()
{
    /*
      ...
      $html .= "<a href='".home_url()."/upload' class=\"top-bar-ma-lnk".(is_user_logged_in() ? "" : " login_modal")."\">Create Coaching Tip</a>";
      $html .= (!is_user_logged_in()) ? "" : "<a href='". get_author_posts_url($current_user->ID) ."' class=\"top-bar-ma-lnk\">My Tips</a>";
      ...
      $html .= "<a href='".home_url()."/all-sports' class=\"top-bar-ma-lnk\">All Sports</a>";
...
function plc_nav()
{
    ...
    $html .= '<li><a href="' . home_url() . '/upload"' . (is_user_logged_in() ? '' : ' class="login_modal"') . '>Create Coaching Tip</a></li>';
    $html .= (!is_user_logged_in()) ? "" : "<li><a href='" . get_author_posts_url($current_user->ID) . "' class=\"top-bar-ma-lnk\">My Tips</a></li>";
    $html .= '<li><a href="' . home_url() . '/trending">Trending</a></li>';
    $html .= '<li class="visible-xs"><a href="' . home_url() . '/all-sports">All Sports</a></li>';
    $html .= '<li class="dropdown hidden-xs"><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="' . home_url() . '/all-sports">All Sports <span class="caret"></span></a>';
        $html .= '<ul class="dropdown-menu">';
            $html .= '<li><a href="' . home_url('/collection/in-football-you-want-to-make-sure-that') . '">Football</a></li>';
            $html .= '<li><a href="' . home_url('/collection/soccer-can-be-brutal-when-coaching') . '">Soccer</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-baseball-collection-is-everything-you-need') . '">Baseball</a></li>';
            $html .= '<li><a href="' . home_url('/collection/heres-the-best-of-the-best-for-tips-routines') . '">Basketball</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-field-hockey-collection') . '">Field Hockey</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-ice-hockey-collection') . '">Ice Hockey</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-general-collection') . '">General</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-lacrosse-collection') . '">Lacrosse</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-rugby-collection') . '">Rugby</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-snow-sports-collection') . '">Snow Sports</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-track-and-field-collection') . '">Track & Field</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-volleyball-collection') . '">Volleyball</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-water-sports-collection') . '">Water Sports</a></li>';
            $html .= '<li><a href="' . home_url('/collection/the-wrestling-collection') . '">Wrestling </a></li>';
$html .= '<li><a href="' . home_url('/collection/the-esports-collection') . '">ESports </a></li>';
$html .= '<li><a href="' . home_url('/collection/the-golf-collection') . '">Golf </a></li>';
        $html .= '</ul>';
    $html .= '</li>';
    
   $html .= '<li class="visible-xs"><a href="' . home_url() . '/about">About</a></li>';
    $html .= '<li class="dropdown hidden-xs"><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="' . home_url() . '/about">About <span class="caret"></span></a>';
        $html .= '<ul class="dropdown-menu">';
	    $html .= '<li><a href="' . home_url('/about') . '">About</a></li>';
            $html .= '<li><a href="' . home_url('/faq') . '">FAQ</a></li>';
	$html .= '</ul>';
    	$html .= '</li>';

    //$html .= '<li><a href="' . home_url() . '/about">About</a></li>';
    $html .= "<li><a class=\"top-bar-ma-lnk" . (is_user_logged_in() ? "" : " login_modal") . "\" id=\"login-out-lnk\">" . (is_user_logged_in() ? "Log Out" : "Login/Join") . "</a></li>";
    //$html .= (is_user_logged_in() ? "" : "<li><a id=\"signup-navbar-link\" class=\"top-bar-ma-lnk\" href='" . home_url() . "/register'>Join") . "</a></li>";
    //$html .= '<li><a href="' . home_url() . '/about">About</a></li>';
...
function ts_top_search($form = '')
{
    ...
    if (is_page(533)) {
        $html .= '<p class="title">Discover new coaching tips</p>';
        ...
        $html .= '<input type="text" class="form-control" value="' . esc_attr(get_search_query()) . '" name="s">';
        ...
        $html .= '<li role="presentation"><a href="' . home_url() . '/upload">Add your first post</a></li>';
...
function aq_font_style($arg = null, $important = false)
{
    ...
    if (!is_null($arg)) {
        ...
        if (count($args) == 1) {
            if ($arg == 'normal')
                return 'font-style: normal ' . esc_attr($important) . '; font-weight: normal ' . esc_attr($important) . ';';
            if ($arg == 'italic')
                return 'font-style: italic ' . esc_attr($important) . '; font-weight: normal ' . esc_attr($important) . ';';
            if ($arg == 'bold')
                return 'font-style: normal ' . esc_attr($important) . '; font-weight: bold ' . esc_attr($important) . ';';
        }
        else
        ...
        if ($return == 'array' || ts_starts_with($return, 'array')) :
            ...
            if ($categories) :
                ...
                foreach ($categories as $category) :
                    ...
                    if ($limit && is_numeric($limit) && $i == $limit)
                        break;
...
function dimox_breadcrumbs()
{
    ...
    if (is_home() || is_front_page()) {
        if (is_home() && get_option('page_for_posts')) {
            ...
            if ($show_on_home == 1)
                $output .= '<div class="breadcrumbs small"><a href="' . esc_url($home_link) . '">' . $text['home'] . '</a></div>';
        }
    } else {
        ...
        if (is_category()) {
            ...
            if ($show_current == 1)
                $output .= $before . ts_trim_text(sprintf($text['category'], single_cat_title('', false)), $current_limit) . $after;
        } elseif (is_search()) {
        ...
        elseif (function_exists('is_woocommerce') && is_woocommerce()) {
            ...
            if (is_shop()) {
                if ($show_current == 1)
                    $output .= $before . ts_trim_text($shop_page->post_title, $current_limit) . $after;
            } else {
        ...
        elseif (is_single() && !is_attachment()) {
            if (get_post_type() != 'post') {
                ...
                if ($show_current == 1)
                    $output .= $delimiter . $before . ts_trim_text(get_the_title(), $current_limit) . $after;
            } else {
                ...
                $cats = str_replace('</a>', '</a>' . $link_after, $cats);
                if ($show_title == 0)
                    $cats = preg_replace('/ title="(.*?)"/', '', esc_attr($cats));
                $output .= $cats;
                if ($show_current == 1)
...
function ts_breadcrumbs()
{
    ...
    if (is_tag()) {
        $output .= '<li>' . __("Tag:", 'ThemeStockyard') . ' ' . single_tag_title('', FALSE) . '</li>';
    }
    if (is_404()) {
        $output .= '<li>' . __("404 - Page not Found", 'ThemeStockyard') . '</li>';
    }
    if (is_search()) {
        $output .= '<li>' . __("Search", 'ThemeStockyard') . '</li>';
    }
    if (is_year()) {
...
function ts_get_video_qs_addons($url, $sep = '')
{
    ...
    if (is_object($url_part) && isset($url_part->query)) {
        ...
        if (isset($qvars['v']))
            unset($qvars['v']);
        if (isset($qvars['list']) && strtolower($qvars['list']) == 'wl')
            unset($qvars['list']);
...
function ts_html5_search_form($form = '')
{
    ...
    <input type="text" placeholder="Search Tip...' . esc_attr($placeholder_text) . '" value="' . esc_attr(get_search_query()) . '" name="s" />
    <button type="submit" class="fa fa-search"></button></div>';

    if (is_page(533)) {
        $form .= '<div class="header-search">
        <a href="' . home_url() . '/upload" class="btn btn-turquoise"><i class="fa fa-plus-circle"></i>add your own tip</a>
...
function ts_footer_widgets()
{
    if (ts_option_vs_default('show_footer_widgets', 1) == 1 && ts_option_vs_default('footer_layout', 'footer4')) :
        ...
        echo '<div id="footer" class="footer-widgets container no-padding footer-custom">' . "\n";
        echo '<div class="row">' . "\n";
...
function ts_custom_comment_list($comment, $args, $depth)
{
    ...
    function aq_resize($url = '', $width = null, $height = null, $crop = null, $single = true, $upscale = false, $id = null)
    {
        ...
        if (true === $upscale)
            add_filter('image_resize_dimensions', 'aq_upscale', 10, 6); // ignore themecheck - not a deprecated function/hook
        ...
        // Okay, leave the ship.
        if (true === $upscale)
            remove_filter('image_resize_dimensions', 'aq_upscale'); // ignore themecheck - not a deprecated function/hook
...
// Here is the point we allow to use larger image size than the original one.
    ...
    function ts_social_sharing($single = true)
    {
        ...
        $quote_text = 'Check out this awesome tip on Coaches Tribune.';
        ...
        $html .= (in_array('twitter', $sharing_options)) ? '<a href="' . esc_url('https://twitter.com/intent/tweet/?text=' . urlencode($twitter_title . ' @CoachesTribune') . '&amp;url=' . urlencode($link)) .' " class="hover-twitter-color share-pop" title="Twitter" rel="nofollow"><i class="fa fa-twitter-square twitter-color"></i><span>Twitter</span></a>' : '';
        ...
        if (is_object($post) && isset($post->ID) && has_post_thumbnail()) {
            ...
            if (!empty($image[0])) {
                $html .= (in_array('pinterest', $sharing_options)) ? '<a href="' . esc_url('http://pinterest.com/pin/create/button/?url=' . urlencode($link) . '&amp;description=' . urlencode($title . ' @CoachesTribune')) . '&amp;media=' . urlencode($image[0]) . '" class="hover-pinterest-color share-pop" title="Pinterest" rel="nofollow"><i class="fa fa-pinterest-square pinterest-color"></i><span>Pinterest</span></a>' : '';
            }
        }

        $html .= (in_array('vk', $sharing_options)) ? '<a href="' . esc_url('http://vk.com/share.php?url=' . urlencode($link) . '&amp;name=' . urlencode($title . ' @CoachesTribune')) . '" class="hover-vk-color share-pop" title="VK" rel="nofollow"><i class="fa fa-vk vk-color"></i><span>VK</span></a>' : '';

        $html .= (in_array('tumblr', $sharing_options)) ? '<a href="' . esc_url('http://www.tumblr.com/share/link?url=' . urlencode($link) . '&amp;name=' . urlencode($title . ' @CoachesTribune')) . '" class="hover-tumblr-color share-pop" title="Tumblr" rel="nofollow"><i class="fa fa-tumblr-square tumblr-color"></i><span>Tumblr</span></a>' : '';

        $html .= (in_array('linkedin', $sharing_options)) ? '<a href="' . esc_url('http://linkedin.com/shareArticle?mini=true&amp;url=' . urlencode($link) . '&amp;title=' . urlencode($title . ' @CoachesTribune')) . '" class="hover-linkedin-color share-pop" title="LinkedIn" rel="nofollow"><i class="fa fa-linkedin-square linkedin-color"></i><span>LinkedIn</span></a>' : '';

        $html .= (in_array('reddit', $sharing_options)) ? '<a href="' . esc_url('http://www.reddit.com/submit?url=' . urlencode($link) . '&amp;title=' . urlencode($title . ' @CoachesTribune')) . '" class="hover-reddit-color share-pop" title="Reddit" rel="nofollow"><i class="fa fa-reddit-square reddit-color"></i><span>Reddit</span></a>' : '';
        ...
        $html .= ($single && in_array('email', $sharing_options)) ? '<a href="' . esc_url('mailto:?subject=' . $title . '&amp;body=@CoachesTribune ' . urlencode($link)) . '" class="email" title="' . __('Email', 'ThemeStockyard') . '" rel="nofollow"><i class="fa fa-envelope"></i><span>' . __('Email', 'ThemeStockyard') . '</span></a>' : '';
    ...
    function ts_get_featured_media($arg = array())
    {
        ...
        if ($post_format == 'gallery') :
            ...
            $seek_thumb_size_name = 'thumb_' . $crop_width . 'x' . $crop_height;
            ...
            $photo11_id = get_post_meta($post->ID, $post_meta_prefix . 'image_11_id', true);
            $photo12_id = get_post_meta($post->ID, $post_meta_prefix . 'image_12_id', true);
            ...
            $photo11 = wp_get_attachment_image_src($photo11_id, $seek_thumb_size_name);
            $photo12 = wp_get_attachment_image_src($photo12_id, $seek_thumb_size_name);
            ...
            $photo11 = (isset($photo11[0])) ? aq_resize($photo11[0], $crop_width, $crop_height, true, true, true, $photo11_id) : '';
            $photo12 = (isset($photo12[0])) ? aq_resize($photo12[0], $crop_width, $crop_height, true, true, true, $photo12_id) : '';
            ...
            $all_photos = array(
                ...
                'id_' . $photo10_id => $photo10, 'id_' . $photo11_id => $photo11, 'id_' . $photo12_id => $photo12
            );
    ...
    function ts_time2str($ts = null)
    {
        ...
        elseif ($diff > 0) {
            ...
            if ($day_diff < 31)
                return (ceil($day_diff / 7) == 1) ? ceil($day_diff / 7) . ' week ago' : ceil($day_diff / 7) . ' weeks ago';
            if ($day_diff < 60)
                return 'last month';
            return date('F Y', $ts);
        }
            ...
            if (ceil($day_diff / 7) < 4)
                return (ceil($day_diff / 7) == 1) ? 'in ' . ceil($day_diff / 7) . ' week' : 'in ' . ceil($day_diff / 7) . ' weeks';
...
// sets or retrieves a cookie
    ...
    function ts_body_class($classes = '')
    {
        ...
        if (!trim($logo) && trim($retina_logo))
            $retina_logo = ''; // because $logo becomes $retina_logo in this case.
...
//Return array ids of trening post 
    ...
    function plc_get_video($attr)
    {
        $video = '<video '
                . 'id="example_video_1" class="video-js vjs-default-skin vjs-big-play-centered" '
                . 'controls '
                . 'preload="' . $attr['preload'] . '" '
                . 'data-setup=\'{"fluid": true}\' '
                . ( $attr['poster'] ? 'poster="' . $attr['poster'] . '"' : '')
                . '>'
                . '<source src="' . $attr['src'] . '" type="' . $attr['type'] . '" />'
    ...
    add_action('wp_ajax_plc_remove_user', 'plc_remove_user');
    add_action('wp_ajax_nopriv_plc_remove_user', 'plc_remove_user');

    function plc_remove_user()
    {
        $status = 'error';
