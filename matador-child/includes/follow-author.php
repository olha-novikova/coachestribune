...
function sendFollowMail( $follow_user_id, $user_id){
	...
	$content = "<div>";
	$content .= "<p>";
	$content .= "Hey, <a href='" . get_author_posts_url($user->ID, $user->user_login) . "'>".$user->user_login."</a> is now following you on coachestribune!";
	$content .= "</p>";
	$content .= "<p>";
...
function getFollowedUsersIds($userId){
	global $wpdb;
    $ret = array();
