...
wp_register_script($page_flow . '-js', get_stylesheet_directory_uri() . '/inc/contest/js/' . $page_flow . '.js', array('jquery'), '0.0.1');
wp_enqueue_script($page_flow . '-js');

get_header();
get_template_part("inc/contest/view/page", $page_flow);
?>
</div>
</div>
<?php wp_footer(); ?>
